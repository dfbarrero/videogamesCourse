...
%\begin{columns}
%	\column{.20\linewidth}
    \includegraphics[width=0.3\linewidth]{figs/meme1.png}\\
	%\column{.050\linewidth}
%    \column{.80\linewidth}
    \includegraphics[width=0.9\linewidth]{figs/meme2.png}\\
%\end{columns}
\end{center}
\end{frame}
...
\begin{frame}[fragile]{Packages}{Installing packages}
	Command-line automatic tool: \texttt{pip} (sometimes \texttt{pip3})
		\begin{itemize}
			\item Very similar to \texttt{apt-get} in Linux or \texttt{brew} in MacOS
...
\subsection{Example 3: List the contents of a directory}
\begin{frame}{Cool code examples}{Example 3: List the contents of a directory}
	\begin{columns}
 	   \column{0.7\textwidth}
		\begin{exampleblock}{}
		\vspace{-0.2cm}
		\lstinputlisting[numbers=left]{code/list-os.py}
		\end{exampleblock}
		...
		\begin{exampleblock}{}
		\vspace{-0.2cm}
		\lstinputlisting[numbers=left]{code/list-pathlib.py}
		\end{exampleblock}
	\end{columns}
\end{frame}
...
\begin{frame}{Arcade}{Open a Window (I)}
	...
	\begin{columns}
		...
		\vspace{-0.2cm}
		\begin{exampleblock}{arcade.py - structured API}
		\vspace{-0.2cm}
		\lstinputlisting[numbers=left]{code/arcade.py}
		\vspace{-0.2cm}
		\end{exampleblock}
