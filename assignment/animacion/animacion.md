# Práctica 2: Dibujar y animar con Arcade

## Objetivos 
- Asimilar el proceso de trabajo con Git.
- Utilizar primitivas básicas de dibujo con Git.
- Manejar la documentación del API de Arcade.
- Practicar el manejo de coordenadas y colores con Arcade.

Esta práctica es una adaptación de [Lab 2: Drawn a Picture](https://learn.arcade.academy/en/latest/labs/lab_02_drawing/drawing.html).

## Prerrequisitos
- [Práctica 1](https://hackmd.io/@dfbarrero/lab-git) terminada.

## Planteamiento


## Paso 1: Hacer un dibujo
...
![Ejemplo de dibujo](https://raw.githubusercontent.com/dfbarrero/videogamesCourse/master/assignment/animacion/final_program.webp)

## Paso 2: Hacer un dibujo con una función

## Paso 3: Hacer una animación
