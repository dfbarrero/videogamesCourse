...
\end{verbatim}
	...
	\vspace{-0.2cm}
	\begin{itemize}
	\item \textit{filename}: Path string
...
\begin{frame}{Sound in Arcade}{Built-in sounds}
	...
	\end{itemize}
	Identified by \texttt{":resources:<path>"}
	    \begin{itemize}
	...
	Use this in your scripts with caution!
\end{frame}
