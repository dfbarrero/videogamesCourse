...
\subsection{Technical topics}
\begin{frame}{Videogames development}{Technical topics}
...
\begin{frame}{Videogames development}{Other topics}
...
\subsection{Game development stages}
\begin{frame}{Videogames development}{Game development stages}
    \begin{columns}
 	   \column{.05\textwidth}
 	   \column{.5\textwidth}
    Game development stages:
 	   ...
 	   \column{.40\textwidth}
		\centering\includegraphics[width=\linewidth]{figs/placeholder.jpg}\\
 	   \column{.05\textwidth}
	\end{columns}
\end{frame}
